" Vim color file
" Converted from Textmate theme PlasticCodeWrap using Coloration v0.2.5
...
if exists("syntax_on")
  ...
  hi LineNr  guifg=#82878b guibg=#1E1E1E gui=NONE
  ...
  hi Folded  guifg=#1e9ae0 guibg=#1E1E1E gui=NONE

  hi Normal  guifg=#f8f8f8 guibg=#1E1E1E gui=NONE
  ...
  hi NonText  guifg=#485056 guibg=#1E1E1E gui=NONE
  ...
  hi SpecialKey  guifg=#485056 guibg=#1E1E1E gui=NONE
